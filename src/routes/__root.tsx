    ...
    <>
      ...
      >
        ...
        <div className="hidden max-sm:block">
          <button
            className="group p-4 text-white hover:cursor-pointer"
            onClick={handleBurgerMenuClick}
            aria-label="Open menu"
          >
            <svg width="33" height="28" viewBox="0 0 33 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                className="fill-grey-light group-hover:fill-pink"
          ...
          {isMenuOpen &&
            createPortal(
              <div className="absolute top-3 right-3 flex flex-col items-center gap-3 border-2 border-grey-light bg-grey-dark p-2 pr-3 pb-3 pl-3">
                <button
                  className="group ml-auto p-2 text-white hover:cursor-pointer"
                  onClick={handleBurgerMenuClick}
